...
if(move_uploaded_file($_FILES['file']['tmp_name'],$upload_directory)){
$connection=mysqli_connect("localhost","root"," ");
mysqli_select_db($connection,"df");
echo"Your File Successfully Uploaded";

mysqli_query("INSERT INTO gravator VALUES ('', '$path')");
}
else{
